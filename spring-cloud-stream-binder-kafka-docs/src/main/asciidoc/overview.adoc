...
Kafka Streams support in Spring Cloud Stream is based on the foundations provided by the Spring Kafka project. For details on that support, see http://docs.spring.io/spring-kafka/docs/1.1.6.RELEASE/reference/html/_reference.html#kafka-streams[Kafaka Streams Support in Spring Kafka].
