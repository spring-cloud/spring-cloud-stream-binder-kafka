	...
	public void testMultipleClientFactoryCustomizers() {
		contextRunner.withUserConfiguration(ClientFactoryCustomizerConfigs.class)
			.run(context -> {
				...
				KafkaMessageChannelBinder kafkaMessageChannelBinder = context.getBean(KafkaMessageChannelBinder.class);
				...
				List<ClientFactoryCustomizer> clientFactoryCustomizers =
					(List<ClientFactoryCustomizer>) ReflectionUtils
					.getField(clientFactoryCustomizersField, kafkaMessageChannelBinder);
